...
function App() {
  ...
  return (
    ...
    <div className="bg-computer bg-cover bg-blend-overlay bg-slate-900/90 px-10 py-10 flex flex-col justify-center">
        <div className='flex flex-col md:flex-row items-center'>
          <div className='flex flex-col lg:w-1/2 w-full text-center md:text-left mt-4'>
            ...
            <button className='mx-auto md:mx-0 text-slate-900 flex items-center justify-center bg-teal-500 p-3 rounded-md text-slate-200 mt-4 w-40'>
    ...
    <div className='px-2 pt-10 pb-10 bg-slate-800'>
        <div className='mb-10 text-slate-400 font-sans flex justify-center items-center'>
          ...
          <h1 className='text-2xl text-slate-400 font-bold ml-4'>
          Development Works
          </h1>
        </div>
     ...
     <div className='px-2 pt-10 pb-10 bg-slate-100'>
        <div className='mb-10 text-slate-400 font-sans flex justify-center items-center'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.994 15.994 0 011.622-3.395m3.42 3.42a15.995 15.995 0 004.764-4.648l3.876-5.814a1.151 1.151 0 00-1.597-1.597L14.146 6.32a15.996 15.996 0 00-4.649 4.763m3.42 3.42a6.776 6.776 0 00-3.42-3.42" />
          </svg>
          <h1 className='text-2xl font-bold ml-4 text-transparent  bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500'>
          Illustration Works
          </h1>
        </div>
        <div className='flex flex-col md:flex-row md:flex-wrap space-y-4 md:space-y-0'>
          <Pic image={bg}/>
          <Pic image={bg}/>
          <Pic image={bg}/>
          <Pic image={bg}/>
        ...
        <footer className='text-center text-slate-500 flex flex-col items-center justify-center mt-10'>
            <h1 className=' font-display text-xl lg:text-2xl'>That's it for now!</h1>
            <p className='mt-2 text-xs lg:text-sm'>If you like my work,</p>
            <button className='text-slate-100 flex items-center justify-center bg-teal-500 p-1 lg:p-2 rounded-md text-slate-200 mt-1 text-sm w-36 lg:w-40'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
              </svg>
              <span className='ml-2 text-xs lg:text-sm font-bold '>  Email me!</span>
            </button>
        </footer>
    </div>
